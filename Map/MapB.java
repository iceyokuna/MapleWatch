...
public class MapB extends Map {
    ...
    public void loadImage() {
        ImageIcon ii = new ImageIcon("src\\Map\\Map2.png");
    ...
    public void loadTile() {
        ...
        try {
            String sCurrentLine;
            br = new BufferedReader(new FileReader("src\\Map\\textMap2.txt"));
        ...
        for (int row = 0; row < mapHeight; row++) {
            ...
            for (int col = 0; col < mapWidth; col++) {
                ...
                if (rc == 6) {
                    tile_list.add(new Tile(78 * col, 33 * row, new Dirt(119, 87, 64, 38), true));
                }
                if (rc == 16) {
                    tile_list.add(new Tile(78 * col + 15, 33 * row, new Dirt(14, 87, 42, 28), false));
                }

                if (rc == 7) {
                    tile_list.add(new Tile(78 * col, 33 * row, new Dirt(192, 87, 61, 38), true));
                }
                if (rc == 17) {
                    tile_list.add(new Tile(78 * col + 13, 33 * row + 2, new Dirt(68, 87, 40, 25), false));
                }
